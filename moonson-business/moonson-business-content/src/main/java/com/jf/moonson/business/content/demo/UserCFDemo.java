package com.jf.moonson.business.content.demo;
 ...
 * @author 季风
 * @version $
 * @since 2022/6/28 11:42
 */
public class UserCFDemo {

    public static void main(String[] args) throws IOException, TasteException {

        // 下载文件：http://grouplens.org/datasets/movielens/
        // 准备数据 这里是电影评分数据
        File file = new File("/Users/ifugle/dev/ml-10M100K/ratings.dat");
